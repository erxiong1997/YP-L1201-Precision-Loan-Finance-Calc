...
import com.loancalculator.finance.manager.databinding.ActivityToolsMassConvertPlfBinding
...
class PlfToolsMassConvertActivity :
        ...
        registerForActivityResult(ActivityResultContracts.StartActivityForResult()) { result ->
            if (result.resultCode == RESULT_OK) {
                result.data?.let {
                    ...
                    if (position > -1) {
                        val data = mMassUnitList[position]
                        if (mCurSelect == "top") {
    ...
    override fun beginViewAndDoLtd() {
        ...
        val data1 = mMassUnitList[0]
        val data2 = mMassUnitList[2]
        mTopUnitData = data1
        ...
        mPlcBinding.tvCalculate.setSafeListener {
            try {
                ...
                mPlcBinding.tvInputValueBottom.text =
                    ToolsMassUnitUtils.convert(valueInput, mTopUnitData, mBottomUnitData)
            } catch (_: Exception) {
    ...
    override fun getLayoutValue(): ActivityToolsMassConvertPlfBinding {
        return ActivityToolsMassConvertPlfBinding.inflate(layoutInflater)
    }
