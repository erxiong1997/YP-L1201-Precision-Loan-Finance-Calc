...
import com.loancalculator.finance.manager.room.tildao.TilCompareDao
import com.loancalculator.finance.manager.room.tildao.TilPersonalLoanDao

@Database(
    entities = [DataPersonalLoanPlf::class, DataComparePlf::class],
    version = 1,
    exportSchema = true
)
abstract class RoomDealTool : RoomDatabase() {
    abstract fun mTilPersonalLoanDao(): TilPersonalLoanDao
    abstract fun mTilCompareDao(): TilCompareDao
}
